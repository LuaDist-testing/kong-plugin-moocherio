...
local plugin_handler = require "kong.plugins.moocherio.handler"

describe("moocherio plugin", function()
  ...
  describe("when say_hello is true", function()
    ...
    it("adds the correct header value of Hello World!!!", function()
      assert.is_not.falsy(ngx.header['moocherio'])
      assert.is_equal("Hello World!!!", ngx.header['moocherio'])
    end)
  ...
  describe("when say_hello is false", function()
    ...
    it("adds the correct header value of Bye World!!!", function()
      assert.is_not.falsy(ngx.header['moocherio'])
      assert.is_equal("Bye World!!!", ngx.header['moocherio'])
    end)
